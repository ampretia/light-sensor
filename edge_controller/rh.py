      ...
      while rx.ready():
         ...
         if msgType==5:
            ...
            if asGain==0:
               ...
               asGainFactor=1
            logging.info("Cfg:  asGain=%d  ltrGainFactory=%f ltrResoultionFactor=%f" % (asGain,ltrGainFactor,ltrResolutionFactor))

         if msgType==3:
            uvi = float(visual["uv"]) / (ltrGainFactor * ltrResolutionFactor * 2300.0)
